...
export class GameAmmo {
    ...
    private async startPhysics() {
        const AmmoJS = await Ammo.call(window);
        (window as any).Ammo = AmmoJS;
        const hk = new AmmoJSPlugin(undefined, AmmoJS)
